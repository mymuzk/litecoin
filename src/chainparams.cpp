...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("node1.martiancoin.online");
        vSeeds.emplace_back("node2.martiancoin.online");
        vSeeds.emplace_back("node3.martiancoin.online");
        vSeeds.emplace_back("node4.martiancoin.online");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet1.martiancoin.online");
        vSeeds.emplace_back("testnet2.martiancoin.online");
        vSeeds.emplace_back("testnet3.martiancoin.online");
